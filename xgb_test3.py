...
if __name__ == "__main__":
	##################################################################
	# call with
	#	time python xgb_test2.py <feats> <drug> <fold>
	# to do all folds
	#	for i in {1..5}; do python xgb_test3.py <numfeats> <drug> '$i'; done
	#	sbatch -c 16 --mem 80G --wrap='for i in {1..5}; do python xgb_test3.py <numfeats> <drug> "$i"; done'
	##################################################################
